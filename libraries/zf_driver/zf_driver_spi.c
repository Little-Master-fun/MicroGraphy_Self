...
static gpio_pin_enum spi_get_cs_pin (spi_cs_pin_enum cs_pin)
{
    ...
    switch(cs_pin)
    {
        ...
        case SPI4_CS2_P07_5: temp_cs_pin = P07_5; break;
    }
    return temp_cs_pin;
}
...
static en_hsiom_sel_t spi_get_cs_hsiom (spi_cs_pin_enum cs_pin)
{
    ...
    switch(cs_pin)
    {
        ...
        case SPI4_CS2_P07_5: temp_cs_hsiom =  P7_5_SCB5_SPI_SELECT2; break;
    }
...
void spi_init (spi_index_enum spi_n, spi_mode_enum mode, uint32 baud, spi_clk_pin_enum clk_pin, spi_mosi_pin_enum mosi_pin, spi_miso_pin_enum miso_pin, spi_cs_pin_enum cs_pin)
{
    ...
    Cy_SysClk_PeriphAssignDivider((en_clk_dst_t)((uint32)PCLK_SCB6_CLOCK + ((uint32)spi_n < 3 ? (uint32)spi_n + 1 : (uint32)spi_n == 3 ? 0 : -1)), CY_SYSCLK_DIV_24_5_BIT, ((uint8)spi_n + 5));
    Cy_SysClk_PeriphSetFracDivider(Cy_SysClk_GetClockGroup((en_clk_dst_t)((uint32)PCLK_SCB6_CLOCK + ((uint32)spi_n < 3 ? (uint32)spi_n + 1 : (uint32)spi_n == 3 ? 0 : -1))), CY_SYSCLK_DIV_24_5_BIT, ((uint8)spi_n + 5), ((divSetting_fp5 & 0x1FFFFFE0ul) >> 5ul), (divSetting_fp5 & 0x0000001Ful));
    Cy_SysClk_PeriphEnableDivider(Cy_SysClk_GetClockGroup((en_clk_dst_t)((uint32)PCLK_SCB6_CLOCK + ((uint32)spi_n < 3 ? (uint32)spi_n + 1 : (uint32)spi_n == 3 ? 0 : -1))), CY_SYSCLK_DIV_24_5_BIT, ((uint8)spi_n + 5));
