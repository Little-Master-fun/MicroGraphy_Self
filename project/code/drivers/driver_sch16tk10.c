...
#define EXTRESN_PORT    P07_5               // ¸´Î»Òý½Å / Reset pin (Òý½Å45)
#define SPI_CS_PIN      P07_4               // GPIO·½Ê½µÄÆ¬Ñ¡Òý½Å / CS pin as GPIO (Òý½Å44)
#define SPI2_CS_PIN     SPI2_CS0_P07_4      // SPIÍâÉèµÄÆ¬Ñ¡Òý½Å / CS pin for SPI peripheral
#define SPI2_SCK_PIN    SPI2_CLK_P07_3      // SPIÊ±ÖÓÒý½Å / SPI clock pin (Òý½Å43)
#define SPI2_MISO_PIN   SPI2_MISO_P07_0     // SPIÖ÷Éè±¸ÊäÈëÒý½Å / SPI master input pin (Òý½Å41)
#define SPI2_MOSI_PIN   SPI2_MOSI_P07_2     // SPIÖ÷Éè±¸Êä³öÒý½Å / SPI master output pin (Òý½Å42)
#define GPIO_RESET      (P07_5)             // ±¸ÓÃ¸´Î»Òý½Å / Alternative reset pin
