...
#define WIRELESS_UART_TX_PIN        (UART1_TX_P04_1)                        // 无线串口对应模块的 RX 要接到单片机的 TX (P4.1)
#define WIRELESS_UART_RX_PIN        (UART1_RX_P04_0)                        // 无线串口对应模块的 TX 要接到单片机的 RX (P4.0)
#define WIRELESS_UART_RTS_PIN       (P22_6)                                 // 无线串口对应模块的 RTS 引脚 (P22.6)
#define WIRELESS_UART_CTS_PIN       (P22_5)                                 // 无线串口 CTS 或控制引脚 (P22.5)
//====================================================自动波特率====================================================
